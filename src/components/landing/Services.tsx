      ...
      <div className="container-tight relative z-10">
        ...
        <div className="space-y-4 max-w-2xl mx-auto">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="group flex items-center gap-4 md:gap-6 p-5 md:p-8 rounded-2xl bg-card border-r-4 border-r-[#D87341] border border-border/30 hover:shadow-lg transition-all duration-300 h-[88px] md:h-auto md:min-h-[100px]"
            >
