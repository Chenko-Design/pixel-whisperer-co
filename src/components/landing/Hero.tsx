    ...
    <section className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl w-full md:mr-[22%]" dir="rtl">
          ...
          <div 
            className="flex justify-center md:justify-end items-center gap-4 mt-10 animate-fade-up text-white md:text-[hsl(220,50%,12%)] text-sm md:text-base md:pl-[20%] px-6 py-3 md:px-0 md:py-0 rounded-full md:rounded-none bg-white/15 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none whitespace-nowrap"
