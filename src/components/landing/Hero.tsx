...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col">
      ...
      <div 
        className="flex-1 relative flex flex-col items-center justify-start px-6 md:px-16 pt-8 md:pt-16 pb-12 md:pb-20"
        style={{
      ...
      >
        ...
        <div className="text-center max-w-4xl mx-auto" dir="rtl">
          ...
          <h1 
              ...
              style={{ textShadow: "2px 4px 8px rgba(0,0,0,0.15)", lineHeight: "1.6" }}
            >
