    ...
    <section className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="text-center max-w-4xl mx-auto" dir="rtl">
          ...
          <h1 
              className="font-matritsa text-[1.85rem] md:text-6xl lg:text-7xl text-white mb-8 animate-fade-up"
          ...
          <p 
            className="text-lg md:text-xl lg:text-2xl mt-4 mb-10 font-semibold"
