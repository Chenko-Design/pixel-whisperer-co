  ...
  return (
    <section className="min-h-screen flex flex-col">
      ...
      >
        ...
        />
        {/* Main content - centered text, positioned to the left */}
        <div className="relative z-10 text-center max-w-4xl w-full md:mr-[22%]" dir="rtl">
          ...
          <p 
            className="text-base md:text-lg lg:text-xl mt-1 md:mt-4 mb-8 md:mb-10 font-semibold md:text-right md:pr-[22%] min-h-[3rem] md:min-h-[2rem]"
          ...
          <div 
            className="flex flex-wrap justify-center md:justify-end gap-4 md:gap-6 mt-4 mb-10 md:mb-20 animate-fade-up md:pl-[15%]"
          ...
          <div 
            className="flex justify-center md:justify-end items-center gap-4 animate-fade-up md:pl-[22%]"
          ...
          <div 
            className="flex justify-center md:justify-end items-center gap-4 mt-10 animate-fade-up text-white md:text-[hsl(220,50%,12%)] text-sm md:text-base md:pl-[15%] px-6 py-3 md:px-0 md:py-0 rounded-full md:rounded-none bg-white/15 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none whitespace-nowrap"
