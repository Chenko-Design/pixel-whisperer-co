...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col">
      ...
      <div 
        className="flex-1 relative flex flex-col items-center justify-start px-6 md:px-16 pt-12 md:pt-12 pb-12 md:pb-20"
        style={{
      ...
      >
        ...
        <div className="text-center max-w-4xl mx-auto" dir="rtl">
          ...
          <h1 
              className="font-matritsa text-[2rem] md:text-6xl lg:text-7xl text-white mb-8 animate-fade-up"
          ...
          <p 
            className="text-lg md:text-2xl lg:text-3xl mt-2 md:mt-4 mb-6 md:mb-10 font-semibold"
          ...
          <div 
            className="flex flex-wrap justify-center items-center gap-4 md:gap-6 mb-14 md:mb-20 animate-fade-up"
