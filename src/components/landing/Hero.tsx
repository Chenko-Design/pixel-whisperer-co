...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-20 w-80 h-80 bg-accent/20 rounded-full blur-3xl animate-pulse-glow" />
      <div className="absolute bottom-40 left-20 w-64 h-64 bg-rose-300/15 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "2s" }} />
