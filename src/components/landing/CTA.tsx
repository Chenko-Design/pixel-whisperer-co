  ...
  return (
    <section className="section-padding" dir="rtl">
      <div className="container-tight" ref={ref}>
        <div className={`bg-gradient-to-b from-[#D5C8BE] to-[#C9BAB0] text-white rounded-3xl p-10 md:p-16 text-center relative overflow-hidden transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
