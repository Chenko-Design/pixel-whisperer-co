    ...
    <section id="portfolio" className="section-padding bg-cream-dark/70" dir="rtl">
      <div className="container-tight">
        <div className="text-center mb-4 md:mb-16">
          <span className="inline-block text-accent font-semibold text-sm tracking-wide mb-3">Portfolio</span>
        ...
        <div className="text-center mt-16">
          <Button size="lg" className="group rounded-full py-3 px-8 bg-white hover:bg-white/90 text-foreground shadow-lg hover:shadow-xl border border-white/50" asChild>
