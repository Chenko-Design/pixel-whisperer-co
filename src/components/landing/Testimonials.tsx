...
const Testimonials = () => {
  return (
    <section className="section-padding relative overflow-hidden" dir="rtl">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-accent/5 decorative-blob blur-3xl animate-morph" />
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-accent to-rose-500 rounded-full flex items-center justify-center shadow-lg">
